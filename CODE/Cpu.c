...
void PE_low_level_init(void)
{
  ...
  /* ### TimerInt "MotorR_DutyTimer" init code ... */
  ...
  /* ### TimerInt "MotorL_DriveTimer" init code ... */
  MotorL_DriveTimer_Init();
  /* ### TimerInt "MotorR_DriveTimer" init code ... */
  MotorR_DriveTimer_Init();
