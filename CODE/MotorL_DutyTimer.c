...
#pragma DATA_SEG MotorL_DutyTimer_DATA /* Select data segment "MotorL_DutyTimer_DATA" */
...
{
  TC0 = TCNT + 0x96U;                  /* Store new value to the compare register */ 
...
ISR(MotorL_DutyTimer_Interrupt)
{
  TC0 += 0x96U;                        /* Add value corresponding with period */
  TFLG1 = 0x01U;                       /* Reset interrupt request flag */
  MotorL_DutyTimer_OnInterrupt();      /* Invoke user event */
}
