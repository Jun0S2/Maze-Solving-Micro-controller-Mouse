...
#pragma DATA_SEG MotorR_DriveTimer_DATA /* Select data segment "MotorR_DriveTimer_DATA" */
...
ISR(MotorR_DriveTimer_Interrupt)
{
  TC3 += CmpVal;                       /* Add value corresponding with period */
  TFLG1 = 0x08U;                       /* Reset interrupt request flag */
  MotorR_DriveTimer_OnInterrupt();     /* Invoke user event */
}
