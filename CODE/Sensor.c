...
**         Priority                    : 1
**         User handling procedure     : Sensor_OnEnd
...
**     Contents  :
**         Measure    - byte Sensor_Measure(bool WaitForResult);
**         GetValue8  - byte Sensor_GetValue8(byte *Values);
**         GetValue16 - byte Sensor_GetValue16(word *Values);
**
...
#pragma DATA_SEG Sensor_DATA           /* Select data segment "Sensor_DATA" */
#pragma CODE_SEG Sensor_CODE
#pragma CONST_SEG Sensor_CONST         /* Constant section for this module */
...
static byte Sensor_OutV[3];            /* Array of measured values */
/*
** ===================================================================
**     Method      :  Sensor_Interrupt (component ADC)
**
**     Description :
...
{
  Sensor_OutV[SumChan] = ATDDR0L;      /* Save measured value */
  ...
  if (SumChan == 3U) {                 /* Is number of measurement equal to the number of channels? */
    ...
    Sensor_OnEnd();                    /* Invoke user event */
...
/*
** ===================================================================
**     Method      :  Sensor_Measure (component ADC)
**
**     Description :
...
** ===================================================================
*/
byte Sensor_Measure(bool WaitForResult)
{
...
/*
** ===================================================================
**     Method      :  Sensor_GetValue8 (component ADC)
**
**     Description :
...
** ===================================================================
*/
byte Sensor_GetValue8(byte *Values)
{
  if (!OutFlg) {                       /* Is measured value(s) available? */
    return ERR_NOTAVAIL;               /* If no then error */
  }
  /* Note: Next 3 lines are speed optimized */
  *Values++ = Sensor_OutV[0];          /* Save measured values to the output buffer */
  *Values++ = Sensor_OutV[1];          /* Save measured values to the output buffer */
  *Values = Sensor_OutV[2];            /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}

/*
** ===================================================================
**     Method      :  Sensor_GetValue16 (component ADC)
**
**     Description :
**         This method returns the last measured values of all channels
**         justified to the left. Compared with <GetValue> method this
...
** ===================================================================
*/
byte Sensor_GetValue16(word *Values)
{
  if (!OutFlg) {                       /* Is measured value(s) available? */
    return ERR_NOTAVAIL;               /* If no then error */
  }
  /* Note: Next 3 lines are speed optimized */
  *Values++ = ((word)(Sensor_OutV[0])) << 8U; /* Save measured values to the output buffer */
  *Values++ = ((word)(Sensor_OutV[1])) << 8U; /* Save measured values to the output buffer */
  *Values = ((word)(Sensor_OutV[2])) << 8U; /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}
